...
export function MatchCardActionForm({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 items-start relative group">
      ...
      {(action.items || []).map((item, idx) => {
        ...
        return (
          <div
            key={idx}
            className="grid grid-cols-2 gap-4 items-start relative group"
          >
            {/* Left Side */}
            ...
            <div className="space-y-2 relative">
              <div className="flex items-center justify-end gap-2">
                ...
                <Button
                  size="icon"
                  variant="ghost"
                  className="h-8 w-8 rounded-lg border shadow-sm group-hover:opacity-100 transition-opacity"
